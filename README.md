...
- **ClickHouse: TTL + материализованные представления.** Настроить TTL для старых записей в `product_changes`, чтобы контролировать объём хранимых данных. Добавить материализованные представления для предрасчёта аналитики по секциям и временным окнам — это снизит нагрузку на ClickHouse при запросах из Grafana.
